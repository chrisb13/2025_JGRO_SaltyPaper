...
if __name__ == "__main__":
    ...
    #for NUM,flx in zip(['36','37','38','39','40'],['00','01','02','03','04']):
        ...
        if rP_CONFIG_TYPE=="SVM":
            ...
            #constant forcing turned into SFX (1000*0.035 multiple similar to sfx2 but with a weaker perturbation so hopefully it doesn't crash like sfx2 did on asfb_c10_00016)
            flxfce=WCONFIG+'/newflxforce_sfx3/flxforce_case_cst_'+str(flx)+'_grid_.nc'
